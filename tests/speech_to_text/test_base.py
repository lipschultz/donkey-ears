...
from donkey_ears.speech_to_text import base
...
@pytest.mark.parametrize(
    "transcripts, expected_best_transcript",
    [
        (
            [
...
def test_base_speech_to_text_getting_best_transcribed_audio():
    ...
    subject.transcribe_audio_detailed = mock.MagicMock(
        return_value=base.DetailedTranscripts(
            [
                base.DetailedTranscript("any transcript 1", 0.99, None),
                base.DetailedTranscript("any transcript 2", 0.89, None),
            ],
